  ...
  case "$SPARK_VERSION" in
    ...
    1.1.0)
      if [[ "$HADOOP_MAJOR_VERSION" == "1" ]]; then
        ...
        wget http://s3.amazonaws.com/spark-related-packages/spark-1.1.0-bin-hadoop2.7.tgz
      fi
      ;;
    1.1.1)
      if [[ "$HADOOP_MAJOR_VERSION" == "1" ]]; then
        ...
        wget http://s3.amazonaws.com/spark-related-packages/spark-1.1.1-bin-hadoop2.7.tgz
      fi
      ;;
    1.2.0)
      if [[ "$HADOOP_MAJOR_VERSION" == "1" ]]; then
        ...
        wget http://s3.amazonaws.com/spark-related-packages/spark-1.2.0-bin-hadoop2.7.tgz
      fi
      ;;
    1.2.1)
      if [[ "$HADOOP_MAJOR_VERSION" == "1" ]]; then
        ...
        wget http://s3.amazonaws.com/spark-related-packages/spark-1.2.1-bin-hadoop2.7.tgz
      fi
      ;;
    *)
      if [[ "$HADOOP_MAJOR_VERSION" == "1" ]]; then
